...
version + extensions, database, Redis, Memcached, Mailpit, RabbitMQ, Meilisearch, Typesense, object storage, Node, Python, git clone, env),
...
`storage`, `worker:<id>`). `envoryx project
