...
export function serviceLabel(kind: string, version?: string, variant?: string): string {
  ...
  const name: Record<string, string> = { php: "PHP", web: webNames[variant ?? ""] ?? i18n.t("Web server"), node: "Node.js", database: dbNames[variant ?? ""] ?? i18n.t("Database"), redis: "Redis", mailpit: "Mailpit", storage: i18n.t("Object storage") };
