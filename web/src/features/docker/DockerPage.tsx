  ...
  return (
    <Card>
      <CardHeader
        ...
        description={t("Images Staqio pulled (PHP, Node, MariaDB, Caddy) that no container uses any more, e.g. after a version change. Images from other sources are never touched.")}
        actions={
