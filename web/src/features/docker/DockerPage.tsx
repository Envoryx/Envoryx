  ...
  return (
    <Card>
      <CardHeader
        ...
        description={t("Images Envoryx pulled (PHP, Node, Python, MariaDB, Caddy, Apache, Nginx) that no container uses any more, e.g. after a version change. Images from other sources are never touched.")}
        actions={
