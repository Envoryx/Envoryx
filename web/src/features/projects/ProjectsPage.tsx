...
function ServiceBadges({ project }: { project: Project }) {
  ...
  const extras = project.services.filter((s) => s.enabled && s.kind !== app && (s.kind === "node" || s.kind === "python" || s.kind === "redis" || s.kind === "memcached" || s.kind === "mailpit" || s.kind === "rabbitmq" || s.kind === "meilisearch" || s.kind === "typesense" || s.kind === "opensearch" || s.kind === "storage"));
  return (
