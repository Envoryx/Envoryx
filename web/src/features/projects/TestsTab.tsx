      ...
      <div className="space-y-6 self-start">
        <Card>
          <CardHeader
            ...
            description={t("Found in the project: PHPUnit and Pest, the test scripts of package.json, Playwright, Cypress, pytest, Django, go test, RSpec and rails test. They run in the runtime container as the project owner.")}
          />
          {q.isPending ? (
            <Spinner />
          ) : q.isError ? (
            ...
            <p className="p-5 text-sm text-muted">{t("No test suite found. Envoryx looks for vendor/bin/phpunit or pest, test scripts in package.json, a Playwright or Cypress configuration, pytest, manage.py, go.mod and Gemfile.")}</p>
          ) : (
