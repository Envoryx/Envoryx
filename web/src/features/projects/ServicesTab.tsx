      ...
      <Dialog
        ...
        description={
          info.external
            ...
            : info.volumeName
            ? t("This removes the container and deletes the volume {{volume}} with all data. The application containers (PHP, Python, Go, Ruby, Node) are recreated without the {{service}} variables.", { volume: info.volumeName, service: title })
            : info.kind === "ollama"
              ? t("This removes the container. The application containers (PHP, Python, Go, Ruby, Node) are recreated without the Ollama variables. The models stay in the shared store.")
              : t("This removes the container. The application containers (PHP, Python, Go, Ruby, Node) are recreated without the {{service}} variables.", { service: title })
        }
        footer={
          <>
