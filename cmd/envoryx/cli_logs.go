...
func (c *cli) projectLogs(ctx context.Context, args []string) error {
	...
	service := fs.String("service", "", "service: php, node, python, go, web, database, redis, memcached, mailpit, rabbitmq, meilisearch, typesense, opensearch, opensearch-dashboards, ollama, storage or worker:<id>")
