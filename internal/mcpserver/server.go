...
func New(d Deps) *Server {
	...
	s.mcp = mcp.NewServer(&mcp.Implementation{Name: "envoryx", Title: "Envoryx", Version: d.Version, WebsiteURL: "https://github.com/envoryx/envoryx"}, &mcp.ServerOptions{
		Instructions: "Envoryx manages Docker-based development environments (web server, PHP and/or Node.js, database, Redis, Memcached, Mailpit, RabbitMQ, Meilisearch, Typesense, OpenSearch, S3-compatible object storage). " +
