...
func (a *API) Mount(mux *http.ServeMux, protect func(http.Handler) http.Handler) {
	...
	p("POST /api/v1/projects/{id}/ide/stop-backend", a.stopIDEBackend)
	p("GET /api/v1/projects/{id}/workers", a.listWorkers)
	p("POST /api/v1/projects/{id}/workers", a.addWorker)
	p("PUT /api/v1/projects/{id}/workers/{worker}", a.updateWorker)
	p("DELETE /api/v1/projects/{id}/workers/{worker}", a.removeWorker)
	...
	p("POST /api/v1/projects/{id}/images", a.useImage)
	p("GET /api/v1/dbtool", a.dbToolStatus)
	p("PUT /api/v1/dbtool", a.setDBTool)
	p("POST /api/v1/projects/{id}/dbtool", a.openDBTool)
	// The database browser lives inside the UI origin so the session protects it.
	mux.Handle(project.DBToolPathPrefix+"/", protect(newDBToolProxy(a.d.Projects)))
	...
	p("PUT /api/v1/projects/{id}/backups/schedule", a.setBackupSchedule)
